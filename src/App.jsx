...
function App() {
  ...
  return (
    <>
      {/* LOGO */}
      <div className='p-5 font-bold border-b-2 text-white flex justify-between h-16.5 bg-gradient-to-r from-purple-500 to-pink-500'>
        <div>G&G</div>
        <div className='hover:border-b-2 cursor-pointer text-white'>Home</div>
      </div>
