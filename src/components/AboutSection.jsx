        ...
        <div className="lg:col-span-6 space-y-5 sm:space-y-6 pt-4 sm:pt-6 lg:pt-0">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 pt-2">
            <div className="p-3.5 sm:p-4 rounded-2xl bg-[#DCE9F4]/50 border border-[#DCE9F4]">
              <span className="text-xl sm:text-2xl font-black text-[#1E6FBA] block">100%</span>
              <span className="text-xs text-slate-600 font-semibold">Fresh Daily Sourcing</span>
            </div>
            <div className="p-3.5 sm:p-4 rounded-2xl bg-[#DCE9F4]/50 border border-[#DCE9F4]">
              <span className="text-xl sm:text-2xl font-black text-[#1E6FBA] block">20+</span>
              <span className="text-xs text-slate-600 font-semibold">Traditional Dishes</span>
            </div>
          </div>
        </div>
