...
export default function MenuSection({
  ...
  return (
    <div id="menu" className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16 sm:space-y-20 scroll-mt-20">
        ...
        <div className="space-y-6 sm:space-y-8">
          <div className="flex items-center justify-between pb-3 border-b border-slate-200">
            <h3 className="text-xl sm:text-2xl font-black text-[#1E6FBA] capitalize">
              {activeCategory === 'all' ? `Search: "${searchQuery}"` : `${activeCategory} Dishes`}
            </h3>
          ...
          {dishes.length > 0 ? (
            ...
            <div className="text-center py-12 sm:py-16 bg-[#F8FAFC] rounded-3xl border border-slate-200 max-w-md mx-auto p-6">
              ...
              <h4 className="text-base font-bold text-slate-800">No dishes match your search</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6">
              ...
              >
                ...
                <div className="absolute bottom-5 left-5 right-5 sm:bottom-6 sm:left-6 sm:right-6 flex items-end justify-between">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-black text-white">Crispy Chicken Quarter</h3>
                    <p className="text-xs text-slate-300 max-w-xs mt-0.5">Deep seasoned and golden fried</p>
                  </div>
              ...
              <div className="md:col-span-6 grid grid-cols-2 gap-4 sm:gap-6">
                ...
                >
                  ...
                  <div className="absolute bottom-3.5 left-4 right-4 sm:bottom-4 sm:left-5 sm:right-5 flex items-center justify-between">
                    <div>
                      <h4 className="text-base sm:text-lg font-black text-white">Spicy Peppered Beef</h4>
                      <p className="text-[10px] sm:text-[11px] text-slate-300">Tender beef cuts in scotch bonnet glaze</p>
                    </div>
                    <span className="text-sm sm:text-base font-black text-amber-400">₦2,500</span>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="absolute bottom-2.5 left-3 right-3 flex items-center justify-between">
                    <span className="text-xs sm:text-sm font-black text-white">Dodo</span>
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/85 via-transparent to-transparent" />
                  <div className="absolute bottom-2.5 left-3 right-3 flex items-center justify-between">
                    <span className="text-xs sm:text-sm font-black text-white">Chilled Zobo</span>
      ...
      <div className="flex-1 flex flex-col justify-between space-y-3">
        ...
        <div className="space-y-1.5 pt-1">
          ...
          <div className="flex flex-wrap gap-1.5">
            {swallows.map((s, idx) => (
              <span key={idx} className="text-[10px] sm:text-[11px] font-semibold px-2 py-0.5 rounded-md bg-[#EEF5FA] text-[#1E6FBA] border border-blue-100">
                {s}
              </span>
            ))}
          </div>
